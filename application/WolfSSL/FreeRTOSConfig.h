...
#define configTICK_RATE_HZ                      ( ( TickType_t ) 1000 ) // 100000 -> 10 us, 1000 -> 1ms
#define configMAX_PRIORITIES                    ( 5 )
//#ifdef __USE_WOLFSSL__
//#define configMINIMAL_STACK_SIZE                ( ( unsigned short ) 256 )
//#define configTOTAL_HEAP_SIZE                   ( ( size_t ) ( 38 * 1024 ) )
//#else
#define configMINIMAL_STACK_SIZE                ( ( unsigned short ) 256 )
//#define configTOTAL_HEAP_SIZE                   ( ( size_t ) ( 46 * 1024 ) )
#define configTOTAL_HEAP_SIZE                   ( ( size_t ) ( 44 * 1024 ) ) // when using a heap_4.c
...
/* Message Queue definitions. ( Have to set 0 to configUSE_PREEMPTION ) */
#define configQUEUE_REGISTRY_SIZE               8

/* Co-routine definitions. ( Have to set 1 to configUSE_IDLE_HOOK ) */
