/**
  ******************************************************************************
  * @file    ewbm_gyroscope.h
  * @author  eWBM
  * @version V0.1
  * @date    29-07-2016
  * @brief   Header file of Gyroscope Sensor module
  ******************************************************************************
  * @attention
  *
...
#ifndef __EWBM_GYROSCOPE_H__
#define __EWBM_GYROSCOPE_H__
...
/** @defgroup GYROSCOPE_External_Types GYROSCOPE Exported Types
  * @{
  */

/**
  * @brief  MPU6050(Gyroscope sensor) control register
  */
...
// there are no registers at 0x02 ... 0x18,
// but according other information
// the registers in that unknown area are for gain and offsets.
#define MPU6050_REG_AUX_VDDIO          0x01   // R/W
...
#define MPU6050_REG_FF_THR             0x1D   // R/W
#define MPU6050_REG_FF_DUR             0x1E   // R/W
#define MPU6050_REG_MOT_THR            0x1F   // R/W
#define MPU6050_REG_MOT_DUR            0x20   // R/W
#define MPU6050_REG_ZRMOT_THR          0x21   // R/W
#define MPU6050_REG_ZRMOT_DUR          0x22   // R/W
...
#define MPU6050_REG_MOT_DETECT_STATUS  0x61   // R
