...
// I2C Peripheral ID1 Register
#define I2C_PERI_ID1_PART_NUM_HI    (0xf)   // Upper 4 bits of I2C Part Number
#define I2C_PERI_ID1_CONFIG_NUM     (0xf)   // I2C Configuration Number

// I2C Peripheral ID2 Register
#define I2C_PERI_ID2_MAJ_REV        (0xf)   // I2C Major Revision Number
#define I2C_PERI_ID2_MIN_REV        (0xf)   // I2C Minor Revision Number
...
#define SPI3_STS_RX_TIME_OVER           (1<<5) // Receive TimeOver
...
#define GPIO_PERI_ID_PART_NUM      (0xfff)    // GPIO Part Number
#define GPIO_PERI_ID_CONFIG_NUM    (0xf)      // GPIO Configuration Number
#define GPIO_PERI_ID_MAJ_REV       (0xf)      // GPIO Major Revision
#define GPIO_PERI_ID_MIN_REV       (0xf)      // GPIO Minor Revision
#define GPIO_PERI_ID_RSVD_NUM      (0xff)     // GPIO Reserved Number
...
//TIMER PERI ID0 REG BIT DEFINE
#define TIMER_PERI_ID0_PART_NUM     (0xfff)     // Timer Part Number)
#define TIMER_PERI_ID0_CONFIG_NUM   (0xf0000)   // Timer Configuration Number

//TIMER PERI ID1 REG BIT DEFINE
#define TIMER_PERI_ID1_MAJ_REV      (0xf)       // Timer Major Revision
#define TIMER_PERI_ID1_MIN_REV      (0xf0)      // Timer Minor Revision
#define TIMER_PERI_ID1_RSVD_NUM     (0xff00)    // Timer Reserved Number
...
// WDT PERI ID0 REG BIT DEFINE
#define WDT_PERI_ID0_PART_NUM     (0xfff)   // WDT Part Number)
#define WDT_PERI_ID0_CONFIG_NUM   (0xf)     // WDT Configuration Number

// WDT PERI ID1 REG BIT DEFINE
#define WDT_PERI_ID1_MAJ_REV      (0xf)     // WDT Major Revision
#define WDT_PERI_ID1_MIN_REV      (0xf)     // WDT Minor Revision
#define WDT_PERI_ID1_RSVD_NUM     (0xff)    // WDT Reserved Number
 ...
 *                                      ARIA START                                             *
************************************************************************************************/
typedef struct _tARIA_REG
{   
    __RW uint32_t  cr;
    __RO uint32_t  sr;
    __WO uint32_t  dinr;
    __RO uint32_t  doutr;
    __RW uint32_t  keyrr0;
    __RW uint32_t  keyrr1;
    __RW uint32_t  keyrr2;
    __RW uint32_t  keyrr3;
    __RW uint32_t  keylr0;
    __RW uint32_t  keylr1;
    __RW uint32_t  keylr2;
    __RW uint32_t  keylr3;
    __RO uint32_t  peri_id;
} tARIA_REG;

#define ARIA    ((tARIA_REG*)ARIA_BASE_ADDR)
